...
@configclass
class SingleTeleopDevSceneCfg(InteractiveSceneCfg):
...
@configclass
class SingleTeleopEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the reach end-effector pose tracking environment."""

    # Scene settings
    scene: SingleTeleopDevSceneCfg = SingleTeleopDevSceneCfg(num_envs=4096, env_spacing=2.5)
    # Basic settings
