...
def main():
    ...
    elif args_cli.teleop_device.lower() == "phantomomni":
        teleop_interface = PhantomOmniTeleop(pos_sensitivity=1.0, rot_sensitivity=1.0)
    else:
        raise ValueError(
            f"Invalid device interface '{args_cli.teleop_device}'. Supported: 'keyboard', 'spacemouse', 'phantomomni."
        )
